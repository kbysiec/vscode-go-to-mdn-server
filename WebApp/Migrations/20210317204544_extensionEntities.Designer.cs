...
namespace WebApp.Migrations
{
    ...
    [Migration("20210317204544_extensionEntities")]
    partial class extensionEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Models.Item", b =>
                {
                    ...
                    b.Property<string>("BreadcrumbsString")
                        .HasColumnName("Breadcrumbs")
                        .HasColumnType("TEXT");

                    b.Property<int?>("MdnDataId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WebApp.Models.MdnData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WebApp.Models.Item", b =>
                {
                    b.HasOne("WebApp.Models.MdnData", null)
                        .WithMany("Items")
                        .HasForeignKey("MdnDataId");

                    b.HasOne("WebApp.Models.Item", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId");

                    b.HasOne("WebApp.Models.Item", "RootParent")
                        .WithMany()
